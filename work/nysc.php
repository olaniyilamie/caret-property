<?php 
session_start();
if (isset($_SESSION['accountype'=='nysc'])) {
		...
		<body>
			<div class="container-fluid">
				...
				<div class="col-12" >
						...
						<form class="form-group" action="nyscact.php" method="POST">
							...
							<input type="text" name="school" placeholder="SCHOOL ATTENDED" class="form-control form-control-sm mb-2">
							<input type="text" name="course" placeholder="COURSE STUDIED" class="form-control form-control-sm mb-2">
				</div>	
							<div class="col-2">
								<label for="date" style=" border: 1px solid #D6D8D9;font-size: 13px"  class="p-1">SERVICE START DATE</label>
							</div>
							<div class="col-10">
								<input type="date" id="date"name="date" placeholder="START DATE" class="form-control form-control-sm mb-2">
							</div>
				<div class="col-12">
							<input type="text" name="grade" placeholder="GRADE" class="form-control form-control-sm mb-2">
							<p class="mb-0"style="font-size: 8px"> <span class="red">*</span>Convince your employer in few sentences on why they should employ you. e.g what you can bring to the company or your skills</p>
